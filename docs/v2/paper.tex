...
\end{tikzpicture}
\caption{TITAN-BERT-ULTRA global architecture. Input tokens pass through embedding, 12 hybrid layers (processed in 2 recursive loops for 24 logical layers), and a BitLinear output head.}
\label{fig:architecture}
\end{figure}

\begin{table}[H]
\centering
\caption{TITAN-BERT-ULTRA Configuration (Updated for Stability)}
\label{tab:config}
\begin{tabular}{@{}ll@{}}
\toprule
...
\begin{table}[H]
\centering
\caption{TITAN-BERT-ULTRA Experimental Configuration}
...
\end{tikzpicture}
\caption{Stability issues and their mitigations in the TITAN-BERT-ULTRA architecture.}
\label{fig:stability}
\end{figure}
